...
color_scale = alt.Scale(
    domain=[-max_abs_growth, -0.6 * max_abs_growth, -0.1 * max_abs_growth, 0.1 * max_abs_growth, 0.6 * max_abs_growth, max_abs_growth],
    range=["#4575b4", "#5e4fa2", "#762a83", "#762a83", "#b2182b", "#d73027"]
)
